...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'http://66.96.208.81/adswebapi/api/deviceinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
...
$(document).ready(function () {
    ...
    var DeviceAPI = "";
    if (getSessionstorageValueRoleID == 1) {
        DeviceAPI = "http://66.96.208.81/adswebapi/api/deviceinfo?ResellerID=" + "1" + "&CompanyID=" + "1";
    } 
    else if (getSessionstorageValueRoleID == 2){
        DeviceAPI = "http://66.96.208.81/adswebapi/api/deviceinfo?ResellerID=" + getSessionstorageValueUserResellerID + "&CompanyID=" + getSessionstorageValueCompanyID;
    }

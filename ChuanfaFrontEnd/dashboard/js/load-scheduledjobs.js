...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        WebAPIJobDriver = 'http://66.96.208.81/adswebapi/api/driverinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
    }

    else if (getSessionstorageValueRoleID == 2) {
        WebAPIJobDriver = 'http://66.96.208.81/adswebapi/api/driverinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
    ...
    $('#jobAssets').on('change', function () {
        var selectedAsset = $(this).find("option:selected").val();
        if (selectedAsset == 0)
        {
            if ($("#driver option[value='']").length > 0)
            {
                $("#driver option[value='']").remove();
            }
         
            $('#driver').append($('<option selected="selected"></option>').val('').html('Select Driver...'));
            $('.selectpicker').selectpicker('refresh');
        }
        else
        {
            $.getJSON(WebAPIJobDriver, function (data) {
                $.each(data, function (index, item) {

                    if (item.AssetID == selectedAsset) {
                        $('#driver').val(item.Name);
                    }
                });
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        WebAPI = 'http://66.96.208.81/adswebapi/api/jobinfo?AssetResellerID=' + "1" + '&AssetCompanyID=' + "1" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&JobType=Scheduled' + '&Trip=1' + '&isReturn=1' + '&Flag=1';
    }
    else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'http://66.96.208.81/adswebapi/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + "" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&JobType=Scheduled' + '&Trip=1' + '&isReturn=1' + '&Flag=1';
    }
    else if (getSessionstorageValueRoleID >= 3) {
        WebAPI = 'http://66.96.208.81/adswebapi/api/jobinfo?AssetResellerID=' + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&AssetID=' + getAssets + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&JobType=Scheduled' + '&Trip=1' + '&isReturn=1' + '&Flag=1';
    }
...
function GenerateEN() {
        ...
        var jobApi = 'http://66.96.208.81/adswebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&JobType=Scheduled' + '&Trip=1' + '&isReturn=1' + '&Flag=1';
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueUser == null | getSessionstorageValueUser == undefined | getSessionstorageValueUser == "") {
        ...
        localStorage.clear();
        window.location.href = 'http://66.96.208.81/ads/'; //Login URL

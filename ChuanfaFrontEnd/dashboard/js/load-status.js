...
if (getSessionstorageValueRoleID == 1) {
    var getZone = 'http://66.96.208.81/adswebapi/api/zoneinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
    ...
    var getZoneByID = 'http://66.96.208.81/adswebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    ...
    var getZoneByID = 'http://66.96.208.81/adswebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;

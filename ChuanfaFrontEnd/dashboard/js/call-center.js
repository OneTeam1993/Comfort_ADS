...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        if (selectedCompany != 0) {
            ...
            $.getJSON('http://66.96.208.81/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + selectedCompany, function (data) {
...
function setMarkers(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        MarkerAPI = 'http://66.96.208.81/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';

    } else if (getSessionstorageValueRoleID == 2) {

        MarkerAPI = 'http://66.96.208.81/adswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
function findClosestN(pt, numberOfResults) {
    ...
    for (var i = 0; i < markers.length; i++) {
        ...
        if (markers[i].assetflag == 1 && markers[i].flag >= 0) closest.push(markers[i]);
    }
...
function searchDriver(id) {
    ...
    var apiDriver = 'http://66.96.208.81/adswebapi/api/driverinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&AssetID=' + id;
    var apiDevice = 'http://66.96.208.81/adswebapi/api/deviceinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&AssetID=' + id;
    //alert(apiDriver);
...
function searchJob() {
    ...
    var apiJobNumber = 'http://66.96.208.81/adswebapi/api/searchjob?JobNumber=' + getJobNumber;
    //alert(apiJobNumber);

    $.ajax({
        url: 'http://66.96.208.81/adswebapi/api/hospitalinfo',
        type: 'GET',
        dataType: 'json',
...
$(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPIUser = 'http://66.96.208.81/adswebapi/api/userinfo?ResellerID=' + '1' + '&CompanyID=' + '1' + '&RoleID=' + getSessionstorageValueRoleID;
        ...
        WebAPIUser = 'http://66.96.208.81/adswebapi/api/userinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&RoleID=' + getSessionstorageValueRoleID;
    ...
    $('.SelectAgentFilter').on('change', function () {
        ...
        WebAPIJobs = 'http://66.96.208.81/adswebapi/api/jobinfofilter?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&Agent=' + selected + '&JobType=Normal';
...
function reloadJobsCreated() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPIJobs = 'http://66.96.208.81/adswebapi/api/jobinfofilter?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&JobType=Normal';
    }
    else if (getSessionstorageValueRoleID == 2) {
        ...
        WebAPIJobs = 'http://66.96.208.81/adswebapi/api/jobinfofilter?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&Agent=' + getSessionstorageValueUser + '&JobType=Normal';
    }

...
//Load Events
$.getJSON("http://66.96.208.81/adswebapi/api/statusinfo", function (data) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("http://66.96.208.81/adswebapi/api/assetinfo?UserID=" + '&ResellerID=' + "1" + '&CompanyID=' + "1", function (data) {
        $.each(data, function (index, item) {
    ...
    $('#load-assets').append($('<option value="" selected=""></option>').val('').html("ALL"));
    $.getJSON("http://66.96.208.81/adswebapi/api/assetinfo?UserID=" + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID, function (data) {
        $.each(data, function (index, item) {
            $('#load-assets').append(
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("http://66.96.208.81/adswebapi/api/assetinfo", function (data) {
        $.each(data, function (index, item) {
            $('#load-assets2').append(
                 $('<option></option>').val(item.Name).html(item.Name)
             );
    ...
    $.getJSON("http://66.96.208.81/adswebapi/api/assetinfo?UserID=" + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID, function (data) {
        $.each(data, function (index, item) {
            $('#load-assets2').append(
                 $('<option></option>').val(item.Name).html(item.Name)
             );
...
function bedFormatter(value, row) {
...
$(function () {
    ...
    function Generate() {
        ...
        var timestampJobs = moment(convertTimestamp).subtract('minutes', 495).format(dateFormat);
        var rxtimeJobs = moment(convertRxtime).subtract('minutes', 495).format(dateFormat);
        ...
        //if (timestamp < rxtime) {
            ...
            if (validateTimestamp == true && validateRxTime == true) {
                ...
                if (getAsset == "")
                {
                    ...
                    WebApiCVR = "http://66.96.208.81/adswebapi/api/cvrinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Speed=" + convertMilesPerHour;
                    WebApi = "http://66.96.208.81/adswebapi/api/posinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Speed=" + convertMilesPerHour;
                    WebApiBarlight = "http://66.96.208.81/adswebapi/api/posinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Barlight=1";
                    jobApi = 'http://66.96.208.81/adswebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestampJobs + '&RxTime=' + rxtimeJobs + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType;
                    jobApiReport = 'http://66.96.208.81/adswebapi/api/jobreport?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestampJobs + '&RxTime=' + rxtimeJobs + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType + '&Destination=' + getDestination;
                    jobApiWardReport = 'http://66.96.208.81/adswebapi/api/jobward?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestampJobs + '&RxTime=' + rxtimeJobs + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType + '&Destination=' + getDestination;
                }
                else
                {
                    if (getReseller == "" || getReseller == "undefined" || getReseller == null)
                    ...
                    WebApiCVR = "http://66.96.208.81/adswebapi/api/cvrinfo?Asset=" + getAsset + "&Speed=" + convertMilesPerHour + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    WebApi = "http://66.96.208.81/adswebapi/api/posinfo?Asset=" + getAsset + "&Speed=" + convertMilesPerHour + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    WebApiBarlight = "http://66.96.208.81/adswebapi/api/posinfo?Asset=" + getAsset + "&Speed=" + convertMilesPerHour + "&Barlight=1" + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    jobApi = 'http://66.96.208.81/adswebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Asset=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType;
                    jobApiReport = 'http://66.96.208.81/adswebapi/api/jobreport?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestampJobs + '&RxTime=' + rxtimeJobs + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType + '&Destination=' + getDestination;
                    jobApiWardReport = 'http://66.96.208.81/adswebapi/api/jobward?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestampJobs + '&RxTime=' + rxtimeJobs + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType + '&Destination=' + getDestination;
                }
                ...
                if (getLocalstorageValueRetrieveReport == "reports-positions") {
                    ...
                    if (strEvent == 12 | strEvent == 13) {
                        WebApiEvent = "http://66.96.208.81/adswebapi/api/eventinfo/?StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + '&CompanyID=' + getCompany + '&AckRoleID=' + getSessionstorageValueRoleID;
                        ...
                        WebApiEvent = "http://66.96.208.81/adswebapi/api/eventinfo/?Asset=" + getAsset + "&StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                        ...
                        $('#' + getLocalstorageValueRetrieveReport).bootstrapTable(
                            {
                                ...
                                onPageChange: function (data, row) {
...
$.getJSON("http://66.96.208.81/adswebapi/api/reportinfo", function (data) {
    $.each(data, function (index, item) {

        if (item.Name != "Mileage" && item.Name != "Messages" && item.Name != "Comprehensive Vehicle Report")
        {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    WebAPIAgent = 'http://66.96.208.81/adswebapi/api/userinfo?ResellerID=' + '1' + '&CompanyID=' + '1' + '&RoleID=' + getSessionstorageValueRoleID;

} else if (getSessionstorageValueRoleID == 2) {
    WebAPIAgent = 'http://66.96.208.81/adswebapi/api/userinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&RoleID=' + getSessionstorageValueRoleID;
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("http://66.96.208.81/adswebapi/api/companyinfo", function (data) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    MobileWebAPIReseller = 'http://66.96.208.81/adswebapi/api/resellerinfo';
    ...
    MobileWebAPIReseller = 'http://66.96.208.81/adswebapi/api/resellerinfo?ResellerID=' + getSessionstorageValueUserResellerID;
...
$('#generatemobile').on('click', function () {
    ...
    var webapiMobile = "http://66.96.208.81/adswebapi/api/posinfo?Asset=" + vehicle + "&Speed=" + speed + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var WebApiEvent = "http://66.96.208.81/adswebapi/api/eventinfo/?Asset=" + vehicle + "&StatusID=" + getStatusID + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var WebApiMessages = "http://66.96.208.81/adswebapi/api/messageinfo?Asset=" + vehicle + "&Flag=" + getFlag + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var jobApi = 'http://66.96.208.81/adswebapi/api/jobinfo?AssetResellerID=' + reseller + '&AssetCompanyID=' + company + '&Asset=' + vehicle + '&Timestamp=' + datefrom + '&RxTime=' + dateto + '&Flag=0' + '&Payment=' + getPayment;
        ...
        if (strEvent == 12 | strEvent == 13) {
            ...
            $(document).ready(function () {
                ...
                $('#reports-events').bootstrapTable(
                    {
                        idField: 'EventID',
                        url: 'http://66.96.208.81/adswebapi/api/eventinfo/?StatusID=' + getStatusID + '&Timestamp=' + datefrom + '&RxTime=' + dateto + "&CompanyID=" + company + "&AckRoleID=" + getSessionstorageValueRoleID,
                        columns: [{
                            field: 'Timestamp',
                            title: 'Timestamp',
...
$(document).ready(function () {
    ...
    //Load Hospital
    $.getJSON("http://66.96.208.81/adswebapi/api/hospitalinfo", function (data) {
        $.each(data, function (index, item) {

...
//OnLoad User Role
$.getJSON("http://66.96.208.81/adswebapi/api/roleinfo?RoleID=" + getSessionstorageValueRoleID, function (data) {
    $.each(data, function (index, item) {
...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'http://66.96.208.81/adswebapi/api/userinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&RoleID=' + getSessionstorageValueRoleID;
...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'http://66.96.208.81/adswebapi/api/userinfo?ResellerID=' + '1' + '&CompanyID=' + '1' + '&RoleID=' + getSessionstorageValueRoleID;

    } else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'http://66.96.208.81/adswebapi/api/userinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&RoleID=' + getSessionstorageValueRoleID;
...
$.getJSON("http://66.96.208.81/adswebapi/api/languageinfo", function (data) {
    $.each(data, function (index, item) {

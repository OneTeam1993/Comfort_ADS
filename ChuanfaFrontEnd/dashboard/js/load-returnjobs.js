...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        $.getJSON("http://66.96.208.81/adswebapi/api/companyinfo?ResellerID=" + getReseller, function (data) {
        ...
        $.getJSON("http://66.96.208.81/adswebapi/api/assetinfo?UserID=" + "&ResellerID=" + userReseller + "&CompanyID=" + selectedCompany, function (data) {
    ...
    $('.MobileSelectCompanyFilter').on('change', function () {
        ...
        $.getJSON("http://66.96.208.81/adswebapi/api/companyinfo?ResellerID=" + getMobileReseller, function (data) {
...
$(function () {
    ...
    $('.SelectJobResellerFilter').on('change', function () {
        ...
        $('#jobCompany').empty();
        $('#jobCompany').selectpicker('refresh');
        $.getJSON("http://66.96.208.81/adswebapi/api/companyinfo?&ResellerID=" + selectedJobReseller, function (data) {
    ...
    $('.SelectJobCompanyFilter').on('change', function () {
        ...
        $.getJSON("http://66.96.208.81/adswebapi/api/assetinfo?UserID=" + "&ResellerID=" + jobReseller + "&CompanyID=" + selectedJobCompany, function (data) {
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        WebAPI = 'http://66.96.208.81/adswebapi/api/returninfo?AssetResellerID=' + "1" + '&AssetCompanyID=' + "1" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2' + '&Flag=1';
    }
    else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'http://66.96.208.81/adswebapi/api/returninfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + "" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2' + '&Flag=1';
    }
    else if (getSessionstorageValueRoleID >= 3) {
        WebAPI = 'http://66.96.208.81/adswebapi/api/returninfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&AssetID=' + getAssets + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2' + '&Flag=1';
       // var jobApi = 'http://66.96.208.81/adswebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2' + '&Flag=1';
    }
    ...
    $('#jobs-editable').bootstrapTable({
        ...
        onCheck: function (row) {
	        ...
	        else if (row.JobStatus == "Scheduled In Progress" || row.JobStatus == "Scheduled" || row.JobStatus == "Scheduled Edited") {
                // replace the contents of the div
                $('#editform').html("Edit Return Job");
                $("#editform").show();
            ...
            var jobPatientRemarks = $('#patientRemarks').val(row.Remarks2);
            ...
            $('#getOxygen').attr('checked', false);
            $('#getWheel').attr('checked', false);
            $('#getStair').attr('checked', false);
            $('#getStretches').attr('checked', false);
...
//Delete Row
var $table = $('#jobs-editable'), $removeEN = $('#job-confirm-deleteEN');
...
function GenerateEN() {
        ...
        //var jobApi = 'http://66.96.208.81/adswebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
        var jobApi = 'http://66.96.208.81/adswebapi/api/returninfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2' + '&Flag=1';
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueUser == null | getSessionstorageValueUser == undefined | getSessionstorageValueUser == "") {
        ...
        localStorage.clear();
        window.location.href = 'http://66.96.208.81/royal/'; //Login URL
...
function sendAlert() {
    ...
    var emailAlert = {
        Sender: "Advance Dispatch System",
        Recipients: sessionStorage.getItem('setSessionstorageValueDriverPhone'),
        Message: "Edited Job(From: " + getAddress + "\r\n" + "To: " + getDestination + " " + "Pickup: " + getDate + ")",
        Timestamp: moment().format(),
        RxTime: moment().format(),
        Flag: 1,
        CompanyID: sessionStorage.getItem('setSessionstorageValueCompanyID'),
    ...
    if (screen.height == 768) {
        setTimeout(function () {
            ...
            if (isChromium !== null && isChromium !== undefined && vendorName === "Google Inc." && isOpera == false && isIEedge == false) {
                // is Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 365 });
            } else {
                // not Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 390 });
            }
        ...
        setTimeout(function () {
            ...
            if (isChromium !== null && isChromium !== undefined && vendorName === "Google Inc." && isOpera == false && isIEedge == false) {
                // is Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 250 });
            } else {
                // not Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 285 });
            }
        ...
        setTimeout(function () {
            ...
            if (isChromium !== null && isChromium !== undefined && vendorName === "Google Inc." && isOpera == false && isIEedge == false) {
                // is Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 338 });
            } else {
                // not Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 353 });
            }
        ...
        setTimeout(function () {
            ...
            if (isChromium !== null && isChromium !== undefined && vendorName === "Google Inc." && isOpera == false && isIEedge == false) {
                ...
                // not Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 410 });
            }
        ...
        setTimeout(function () {
            ...
            if (isChromium !== null && isChromium !== undefined && vendorName === "Google Inc." && isOpera == false && isIEedge == false) {
                // is Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 435 });
            } else {
                // not Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 480 });
            }
        ...
        setTimeout(function () {
            ...
            if (isChromium !== null && isChromium !== undefined && vendorName === "Google Inc." && isOpera == false && isIEedge == false) {
                // is Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 495 });
            } else {
                // not Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 505 });
            }
        ...
        setTimeout(function () {
            ...
            if (isChromium !== null && isChromium !== undefined && vendorName === "Google Inc." && isOpera == false && isIEedge == false) {
                // is Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 525 });
            } else {
                // not Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 570 });
            }
        ...
        setTimeout(function () {
            ...
            if (isChromium !== null && isChromium !== undefined && vendorName === "Google Inc." && isOpera == false && isIEedge == false) {
                // is Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 590 });
            } else {
                // not Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 620 });
            }
        ...
        setTimeout(function () {
            ...
            if (isChromium !== null && isChromium !== undefined && vendorName === "Google Inc." && isOpera == false && isIEedge == false) {
                // is Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 646 });
            } else {
                // not Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 636 });
            }
        ...
        setTimeout(function () {
            ...
            if (isChromium !== null && isChromium !== undefined && vendorName === "Google Inc." && isOpera == false && isIEedge == false) {
                // is Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 615 });
            } else {
                // not Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 605 });
            }
        ...
        setTimeout(function () {
            ...
            if (isChromium !== null && isChromium !== undefined && vendorName === "Google Inc." && isOpera == false && isIEedge == false) {
                // is Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 760 });
            } else {
                // not Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 755 });
            }
        ...
        setTimeout(function () {
            ...
            if (isChromium !== null && isChromium !== undefined && vendorName === "Google Inc." && isOpera == false && isIEedge == false) {
                // is Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 900 });
            } else {
                // not Google chrome 
                $('#jobs-editable').bootstrapTable('resetView', { height: 895 });
            }
        ...
        setTimeout(function () {
            $('#jobs-editable').bootstrapTable('resetView', { height: 400 });
        }, 500);
    }
}
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                if (assets.AssetID == 'undefined' || assets.AssetID == null || assets.AssetID == 0 || assets.AssetID != GetAssetID) {
                    ...
                    $.ajax({
                        url: "http://66.96.208.81/adswebapi/api/assetinfo",
                        type: "POST",
                    ...
                    var updateAsset = 'http://66.96.208.81/adswebapi/api/assetinfo?id=' + assets.AssetID;
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจว่า คุณต้องการลบ ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'http://66.96.208.81/adswebapi/api/assetinfo/' + row.AssetID;
        ...
        if (perimeter == "" | perimeter == null | perimeter == "undefined" | zoneName == "" | zoneName == null | zoneName == "undefined") {
            ...
            bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
                if (result) {
                    ...
                    var url = 'http://66.96.208.81/adswebapi/api/zoneinfo';
                    var xhr = createCORSRequest('GET', url);
                    xhr.send();
                    if (!xhr) {
                        throw new Error('CORS not supported');
                    ...
                    if (zones.ZoneID == 'undefined' || zones.ZoneID == null || zones.ZoneID == 0 || zones.ZoneID != GetZoneID) {
                        ...
                        $.ajax({
                            url: "http://66.96.208.81/adswebapi/api/zoneinfo",
                            type: "POST",
                        ...
                        var updateZone = 'http://66.96.208.81/adswebapi/api/zoneinfo?id=' + zones.ZoneID;
        ...
        bootbox.confirm("<div style='color:black'>คคุณแน่ใจหรือว่า ต้องการลบ โซน ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'http://66.96.208.81/adswebapi/api/zoneinfo/' + row.ZoneID;
    ...
    $('#submit-company').on('click', function () {
        ...
        bootbox.confirm("ค<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'http://66.96.208.81/adswebapi/api/companyinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (company.CompanyID == 'undefined' || company.CompanyID == null || company.CompanyID == 0 || company.CompanyID != GetCompanyID) {
                    ...
                    $.ajax({
                        url: "http://66.96.208.81/adswebapi/api/companyinfo",
                        type: "POST",
                    ...
                    var updateCompany = 'http://66.96.208.81/adswebapi/api/companyinfo?id=' + company.CompanyID;
        ...
        bootbox.confirm("<div style='color:black'>คคุณแน่ใจหรือว่า ต้องการลบ บริษัท ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'http://66.96.208.81/adswebapi/api/companyinfo/' + row.CompanyID;
    ...
    $('#submit-user').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการส่ง?</div>", function (result) {
            if (result) {
                ...
                var url = 'http://66.96.208.81/adswebapi/api/userinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (user.UserID == 'undefined' || user.UserID == null || user.UserID == 0 || user.UserID != GetUserID) {
                    ...
                    $.ajax({
                        url: "http://66.96.208.81/adswebapi/api/userinfo",
                        type: "POST",
                    ...
                    var updateUser = 'http://66.96.208.81/adswebapi/api/userinfo?id=' + user.UserID;
            ...
            bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
                if (result) {
                    ...
                    var ajaxRequest = $.ajax({
                        type: "POST",
                        url: "http://66.96.208.81/adswebapi/api/fileupload/uploadfileuser",
                        contentType: false,
                        processData: false,
                        data: data,
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ ผู้ใช้?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'http://66.96.208.81/adswebapi/api/userinfo/' + row.UserID;
    ...
    $('#submit-device').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'http://66.96.208.81/adswebapi/api/deviceinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                if (device.DeviceID == 'undefined' || device.DeviceID == null || device.DeviceID == 0 || device.DeviceID != GetDeviceID) {
                    ...
                    $.ajax({
                        url: "http://66.96.208.81/adswebapi/api/deviceinfo",
                        type: "POST",
                    ...
                    var updateDevice = 'http://66.96.208.81/adswebapi/api/deviceinfo?id=' + device.DeviceID;
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ ผู้ใช้?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'http://66.96.208.81/adswebapi/api/deviceinfo/' + row.DeviceID;
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                if (reseller.ResellerID == 'undefined' || reseller.ResellerID == null || reseller.ResellerID == 0 || reseller.ResellerID != GetResellerID) {
                    ...
                    $.ajax({
                        url: "http://66.96.208.81/adswebapi/api/resellerinfo",
                        type: "POST",
                    ...
                    var updateReseller = 'http://66.96.208.81/adswebapi/api/resellerinfo?id=' + reseller.ResellerID;
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ บริษัท ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'http://66.96.208.81/adswebapi/api/resellerinfo/' + row.ResellerID;
    ...
    $('#submit-driver').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการ จะส่ง ?</div>", function (result) {
            if (result) {
                ...
                var url = 'http://66.96.208.81/adswebapi/api/driverinfo';
                var xhr = createCORSRequest('GET', url);
                xhr.send();
                if (!xhr) {
                    throw new Error('CORS not supported');
                ...
                var ajaxRequest = $.ajax({
                    type: "POST",
                    url: "http://66.96.208.81/adswebapi/api/fileupload/uploadfile",
                    contentType: false,
                    processData: false,
                    data: data,
                    success: function (data) {
                ...
                if (driver.DriverID == 'undefined' || driver.DriverID == null || driver.DriverID == 0 || driver.DriverID != getDriverID) {
                    ...
                    $.ajax({
                        url: "http://66.96.208.81/adswebapi/api/driverinfo",
                        type: "POST",
                    ...
                    var updateDriver = 'http://66.96.208.81/adswebapi/api/driverinfo?id=' + driver.DriverID;
        ...
        bootbox.confirm("<div style='color:black'>คุณแน่ใจหรือว่า ต้องการลบ บริษัท ?</div>", function (result) {
            if (result) {
                ...
                var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                    ...
                    var WebAPI = 'http://66.96.208.81/adswebapi/api/driverinfo/' + row.DriverID;
    ...
    $('#submit-userProfileEN').on('click', function () {
        ...
        bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
            if (result) {
                ...
                var updateProfile = 'http://66.96.208.81/adswebapi/api/userinfo?id=' + profile.UserID;
                        ...
                        if (row.Flag == 1 || row.Flag == 2) {
                            bootbox.confirm("<div style='color:black'>Are you sure you wish to edit a job?</div>", function (result) {
                                ...
                                if (result) {
                                    ...
                                    var url = 'http://66.96.208.81/adswebapi/api/jobinfo';
                                    var xhr = createCORSRequest('GET', url);
                                    xhr.send();
                                    if (!xhr) {
                                        throw new Error('CORS not supported');
                                    ...
                                    //Get Asset
                                    $.ajax({
                                        url: "http://66.96.208.81/adswebapi/api/checkdriver",
                                        type: "POST",
                                        data: JSON.stringify(driver),
                                        crossDomain: true,
                                        contentType: 'application/json; charset=utf-8',
                                        ...
                                        success: function (driver) {
                                            ...
                                            if (row.JobStatus == "In Progress" || row.JobStatus == "Job Edited") {
                                                ...
                                                var updateJob = 'http://66.96.208.81/adswebapi/api/jobinfo?id=' + jobEdit.JobID;
                    ...
                    else
                    {
                        ...
                        bootbox.confirm("<div style='color:black'>Are you sure you wish to add a job?</div>", function (result) {
                            ...
                            if (result) {
                                ...
                                var searchAsset = 'http://66.96.208.81/adswebapi/api/searchasset?AssetID=' + $('#assets').val();
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (data, textStatus, xhr) {
                                                ...
                                                if (job.JobID == 'undefined' || job.JobID == null || job.JobID == 0 || job.JobID != getJobID) {
                                                    ...
                                                    var apiJobNumber = 'http://66.96.208.81/adswebapi/api/searchjob?JobNumber=' + job.JobNumber;
                                                    ...
                                                    $.getJSON(apiJobNumber, function (data) {
                                                        ...
                                                        if (data.length == 1) {
                                                            ...
                                                            {
                                                                $.ajax({
                                                                    url: "http://66.96.208.81/adswebapi/api/jobinfo",
                                                                    type: "POST",
                                                    ...
                                                    var updateJob = 'http://66.96.208.81/adswebapi/api/jobinfo?id=' + job.JobID;
                ...
                bootbox.confirm("<div style='color:black'>Are you sure you wish to delete ?</div>", function (result) {
                    if (result) {
                        ...
                        $.niftyNoty({
                            ...
                            var WebAPI = 'http://66.96.208.81/adswebapi/api/jobinfo/' + row.JobID;
 ...
 $('#submit-call').on('click', function () {
     ...
     $.ajax({
         ...
         success: function (data, textStatus, xhr) {
             ...
             var searchAsset = 'http://66.96.208.81/adswebapi/api/searchasset?AssetID=' + sessionStorage.getItem('setSessionstorageValueAvailableAmbulance');
     ...
     if (getName == "" || getAddress == "" || getSN == "") {
         ...
         bootbox.confirm("<div style='color:black'>Are you sure you wish to submit?</div>", function (result) {
             ...
             if (result) {
                 ...
                 var url = 'http://66.96.208.81/adswebapi/api/hospitalinfo';
                 var xhr = createCORSRequest('GET', url);
                 xhr.send();
                 if (!xhr) {
                     throw new Error('CORS not supported');
                 ...
                 if (hospital.HospitalID == 'undefined' || hospital.HospitalID == null || hospital.HospitalID == 0 || hospital.HospitalID != GetHospitalID) {
                     ...
                     var updateHospital = 'http://66.96.208.81/adswebapi/api/hospitalinfo?id=' + hospital.HospitalID;
     ...
     bootbox.confirm("<div style='color:black'>Are you sure you wish to delete ?</div>", function (result) {
         if (result) {
             ...
             var ids = $.map($table.bootstrapTable('getSelections'), function (row) {
                 ...
                 var WebAPI = 'http://66.96.208.81/adswebapi/api/hospitalinfo/' + row.HospitalID;

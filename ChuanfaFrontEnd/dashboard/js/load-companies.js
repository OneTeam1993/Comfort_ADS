...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'http://66.96.208.81/adswebapi/api/companyinfo?ResellerID=' + selectedReseller;
...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1)
    {
        WebAPI = 'http://66.96.208.81/adswebapi/api/companyinfo?ResellerID=' + '1';
    }
    else if (getSessionstorageValueRoleID == 2)
    {
        WebAPI = 'http://66.96.208.81/adswebapi/api/companyinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    }
    else if (getSessionstorageValueRoleID >= 3)
    {
        WebAPI = 'http://66.96.208.81/adswebapi/api/companyinfo?CompanyID=' + getSessionstorageValueCompanyID + "&ResellerID=" + getSessionstorageValueUserResellerID;

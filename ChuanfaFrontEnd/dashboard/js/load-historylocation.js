...
if (getLocalstorageValueAsset == "") {
    ...
    $(document).ready(function () {
        ...
        function setLines(map, lines) {
            ...
            var url = "http://66.96.208.81/adswebapi/api/cvrinfo/?Asset=" + getLocalstorageValueAsset + "&Speed=" + getLocalstorageValueSpeedLimit + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
        ...
        if (getLocalstorageValueAsset == "null" | getLocalstorageValueDateFrom == "null" | getLocalstorageValueDateTo == "null") {
            ...
            if (getSessionstorageValueUser == null | getSessionstorageValueUser == undefined | getSessionstorageValueUser == "") {
                ...
                var WebApi = "http://66.96.208.81/adswebapi/api/cvrinfo/?Asset=" + getLocalstorageValueAsset + "&Speed=" + getLocalstorageValueSpeedLimit + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;

...
$(document).ready(function () {
    ...
    $('#submit-user').on('click', function () {
        ...
        var url = 'http://66.96.208.81/adswebapi/api/login';
        ...
        $.ajax({
            url: "http://66.96.208.81/adswebapi/api/login",
            type: "POST",
                ...
                if (userlogin.ErrorMessage == null)
                {
                    if (userlogin.LoginRetry == "Active")
                    {
                        ...
                        if (userlogin.CompanyID == 0 || userlogin.CompanyID == 2 || userlogin.CompanyID == 1) {
                            ...
                            var updateUserApi = 'http://66.96.208.81/adswebapi/api/updateuserinfo?id=' + UpdateUser.UserID;

...
$(document).ready(function () {
    ...
    $('#submit-user').on('click', function () {
        ...
        var url = 'http://119.75.6.116/adswebapi/api/login';
        ...
        $.ajax({
            url: "http://119.75.6.116/adswebapi/api/login",
            type: "POST",
            ...
            success: function (userlogin) {
                ...
                if (userlogin.ErrorMessage == null)
                {
                    ...
                    {
                        //For Comfort Website
                        if (userlogin.CompanyID == 0 || userlogin.CompanyID == 2) {
                            ...
                            var updateUserApi = 'http://119.75.6.116/adswebapi/api/updateuserinfo?id=' + UpdateUser.UserID;
                            ...
                            $.ajax({
                                ...
                                success: function (UpdateUser) {
                                    ...
                                    $.ajax({
                                        url: "http://119.75.6.116/adswebapi/api/eventinfo",
                                        type: "POST",

...
var url = 'http://119.75.6.116/adswebapi/api/assetinfo';
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        if (selectedCompany != 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                ...
                if (selectedReseller != "") {
                    WebAPICompanyFilter = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + selectedReseller + '&CompanyID=' + selectedCompany;
                } else {
                    WebAPICompanyFilter = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
                }

            }
            else if (getSessionstorageValueRoleID == 2) {

                WebAPICompanyFilter = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedCompany;
            }
            else if (getSessionstorageValueRoleID >= 3) {

                WebAPICompanyFilter = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
            }
            ...
            setZonesFilter(map, zones, handleZones);
                ...
                if (getSessionstorageValueRoleID == 1) {
                    var getZoneAPI = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
                }
            
                else if (getSessionstorageValueRoleID == 2) {
                    var getZoneAPI = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + "&CompanyID=" + selectedCompany;
                }

                else if (getSessionstorageValueRoleID >= 3) {
                    var getZoneAPI = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
                }
    ...
    $('.MobileSelectCompanyFilter').on('change', function () {
        ...
        if (selectedMobileCompany != 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                ...
                if (selectedReseller != "") {
                    WebAPICompanyFilter = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + selectedReseller + '&CompanyID=' + selectedMobileCompany;
                } else {
                    WebAPICompanyFilter = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + selectedMobileCompany;
                }

            }
            else if (getSessionstorageValueRoleID == 2) {

                WebAPICompanyFilter = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedMobileCompany;
            }
            else if (getSessionstorageValueRoleID >= 3) {
            ...
            $.getJSON("http://119.75.6.116/adswebapi/api/zoneinfo?CompanyID=" + selectedMobileCompany, function (data) {
    ...
    $('.MobileSelectVechsFilter').on('change', function () {
        ...
        if (selectedMobileAsset != 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                ...
                if (selectedReseller != "") {
                    WebAPICompanyFilter = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&Assets=' + selectedMobileAsset;
                } else {
                    WebAPICompanyFilter = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + getCompany + '&Assets=' + selectedMobileAsset;
                }

            }
            else if (getSessionstorageValueRoleID == 2) {

                WebAPICompanyFilter = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getCompany + '&Assets=' + selectedMobileAsset;
            }
            else if (getSessionstorageValueRoleID >= 3) {

                WebAPICompanyFilter = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&Assets=' + selectedMobileAsset;
            }
            ...
            $.getJSON("http://119.75.6.116/adswebapi/api/zoneinfo?CompanyID=" + getCompany, function (data) {
...
function setMarkers(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        url = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';

    } else if (getSessionstorageValueRoleID == 2) {

    url = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
function setMarkersFilter(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedReseller != "") {
            url = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + selectedReseller + '&CompanyID=' + selectedCompany;
        } else {
            url = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedCompany;
...
function setMarkersFilterMobile(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedMobileReseller != "") {
            url = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + selectedMobileReseller + '&CompanyID=' + selectedMobileCompany;
        } else {
            url = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + selectedMobileCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedMobileCompany;
...
if (getSessionstorageValueRoleID == 1) {
    ...
    WebAPIAsset = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';
    ...
    WebAPIAsset = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
function setZonesFilter(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedReseller != "") {
            url = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + selectedReseller + '&CompanyID=' + selectedCompany;
        } else {
            url = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + selectedCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedCompany;

    } else if (getSessionstorageValueRoleID >= 3) {

        url = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
function setZonesFilterMobile(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedMobileReseller != "") {
            url = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + selectedMobileReseller + '&CompanyID=' + selectedMobileCompany;
        } else {
            url = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + selectedMobileCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedMobileCompany;
...
function setZonesFilterMobileAsset(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedMobileReseller != "") {
            url = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        } else {
            url = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + getCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getCompany;
...
function setZones(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        url = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + '1' + '&CompanyID=' + '1';

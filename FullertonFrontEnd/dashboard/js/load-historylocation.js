...
if (getLocalstorageValueAsset == "") {
    ...
    $(document).ready(function () {
        ...
        function setLines(map, lines) {
            ...
            var url = "http://119.75.6.116/adswebapi/api/cvrinfo/?Asset=" + getLocalstorageValueAsset + "&Speed=" + getLocalstorageValueSpeedLimit + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
        ...
        if (getLocalstorageValueAsset == "null" | getLocalstorageValueDateFrom == "null" | getLocalstorageValueDateTo == "null") {
            ...
            if (getSessionstorageValueUser == null | getSessionstorageValueUser == undefined | getSessionstorageValueUser == "") {
                ...
                var WebApi = "http://119.75.6.116/adswebapi/api/cvrinfo/?Asset=" + getLocalstorageValueAsset + "&Speed=" + getLocalstorageValueSpeedLimit + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;

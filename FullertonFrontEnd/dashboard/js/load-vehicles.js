...
$(function () {
    ...
    $('.SelectFormCompanyFilter').on('change', function () {
        ...
        if (selectedCompany != 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                WebAPIDriver = 'http://119.75.6.116/adswebapi/api/driverinfo?ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
            }

            else if (getSessionstorageValueRoleID == 2) {
                WebAPIDriver = 'http://119.75.6.116/adswebapi/api/driverinfo?ResellerID=' + getSessionstorageValueUserResellerID;

            }
            else if (getSessionstorageValueRoleID >= 3) {
                WebAPIDriver = 'http://119.75.6.116/adswebapi/api/driverinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
            }
            ...
            if (getSessionstorageValueRoleID == 1) {
                getZone = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
                ...
                getZone = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID;
                ...
                getZone = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        if (getSessionstorageValueRoleID == 1) {
         ...
         WebAPI = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        
        } else {

         WebAPI = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany;
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';

    }
    else if (getSessionstorageValueRoleID == 2)
    {

        WebAPI = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
    }
    else if (getSessionstorageValueRoleID >= 3)
    {
...
var getZone = "";
    ...
    if (getSessionstorageValueRoleID == 1)
    {
        getZone = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
    ...
    if (getSessionstorageValueRoleID == 1) {
        WebAPIDriver = 'http://119.75.6.116/adswebapi/api/driverinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
    }
    ...
    $.getJSON("http://119.75.6.116/adswebapi/api/deviceinfo", function (data) {
        $.each(data, function (index, item) {
...
//Load Drivers
    ...
    function loadDrivers()
    {
        ...
        if (getSessionstorageValueRoleID == 1) {
            WebAPIDriver = 'http://119.75.6.116/adswebapi/api/driverinfo';
        }

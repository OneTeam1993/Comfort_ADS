...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'http://119.75.6.116/adswebapi/api/resellerinfo';

    } else {

        WebAPI = 'http://119.75.6.116/adswebapi/api/resellerinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    }

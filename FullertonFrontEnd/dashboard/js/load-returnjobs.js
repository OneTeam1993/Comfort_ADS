...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        $.getJSON("http://119.75.6.116/adswebapi/api/companyinfo?ResellerID=" + getReseller, function (data) {
        ...
        $.getJSON("http://119.75.6.116/adswebapi/api/assetinfo?UserID=" + "&ResellerID=" + userReseller + "&CompanyID=" + selectedCompany, function (data) {
    ...
    $('.MobileSelectCompanyFilter').on('change', function () {
        ...
        $.getJSON("http://119.75.6.116/adswebapi/api/companyinfo?ResellerID=" + getMobileReseller, function (data) {
...
$(function () {
    ...
    $('.SelectJobResellerFilter').on('change', function () {
        ...
        $('#jobCompany').empty();
        $('#jobCompany').selectpicker('refresh');
        $.getJSON("http://119.75.6.116/adswebapi/api/companyinfo?&ResellerID=" + selectedJobReseller, function (data) {
    ...
    $('.SelectJobCompanyFilter').on('change', function () {
        ...
        $.getJSON("http://119.75.6.116/adswebapi/api/assetinfo?UserID=" + "&ResellerID=" + jobReseller + "&CompanyID=" + selectedJobCompany, function (data) {
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        WebAPI = 'http://119.75.6.116/adswebapi/api/jobinfo?AssetResellerID=' + "1" + '&AssetCompanyID=' + "1" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2';
    }
    else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'http://119.75.6.116/adswebapi/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + "" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2';
    }
    else if (getSessionstorageValueRoleID >= 3) {
        WebAPI = 'http://119.75.6.116/adswebapi/api/jobinfo?AssetResellerID=' + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&AssetID=' + getAssets + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2';
    }
...
function GenerateEN() {
        ...
        //var jobApi = 'http://119.75.6.116/adswebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
        var jobApi = 'http://119.75.6.116/adswebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2';
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueUser == null | getSessionstorageValueUser == undefined | getSessionstorageValueUser == "") {
        ...
        localStorage.clear();
        window.location.href = 'http://119.75.6.116/royal/'; //Login URL

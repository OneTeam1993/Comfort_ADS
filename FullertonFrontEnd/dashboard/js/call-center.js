...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        if (selectedCompany != 0) {
            ...
            $.getJSON('http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + selectedCompany, function (data) {
...
function setMarkers(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        MarkerAPI = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';

    } else if (getSessionstorageValueRoleID == 2) {

        MarkerAPI = 'http://119.75.6.116/adswebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
    ...
    geocoder.geocode({
        ...
        if (status == google.maps.GeocoderStatus.OK) {
            ...
            if (address.length == 6 && isNaN(address) == false || address.length == 16 && isNaN(address) == false) {
                ...
                //Reverse Geocode
                var getAPI = "http://119.75.6.116/adswebapi/api/reversegeocode?PosY=" + lat + "&PosX=" + lng;
                console.log(getAPI);
...
function searchDriver(id) {
    ...
    var apiDriver = 'http://119.75.6.116/adswebapi/api/driverinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&AssetID=' + id;
    var apiDevice = 'http://119.75.6.116/adswebapi/api/deviceinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&AssetID=' + id;
    //alert(apiDriver);
...
function searchJob() {
    ...
    var apiJobNumber = 'http://119.75.6.116/adswebapi/api/searchjob?JobNumber=' + getJobNumber;
    //alert(apiJobNumber);

    $.ajax({
        url: 'http://119.75.6.116/adswebapi/api/hospitalinfo',
        type: 'GET',
        dataType: 'json',
...
$(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPIUser = 'http://119.75.6.116/adswebapi/api/userinfo?ResellerID=' + '1' + '&CompanyID=' + '1' + '&RoleID=' + getSessionstorageValueRoleID;
        ...
        WebAPIUser = 'http://119.75.6.116/adswebapi/api/userinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&RoleID=' + getSessionstorageValueRoleID;
    ...
    $('.SelectAgentFilter').on('change', function () {
        ...
        WebAPIJobs = 'http://119.75.6.116/adswebapi/api/jobinfofilter?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Agent=' + selected + '&JobType=Normal';
...
function generateJobNumber() {
    ...
    $.ajax({
        url: 'http://119.75.6.116/adswebapi/api/generatejobid',
        type: 'GET',
        dataType: 'json',
...
function reloadJobsCreated() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPIJobs = 'http://119.75.6.116/adswebapi/api/jobinfofilter?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&JobType=Normal';
    }
    else if (getSessionstorageValueRoleID == 2) {
        ...
        WebAPIJobs = 'http://119.75.6.116/adswebapi/api/jobinfofilter?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Agent=' + getSessionstorageValueUser + '&JobType=Normal';
    }
...
$(document).ready(function () {
    ...
    $.getJSON("http://119.75.6.116/adswebapi/api/hospitalinfo", function (data) {
        $.each(data, function (index, item) {

...
var i = 0;
    ...
    function setLines(map, lines) {
        ...
        webapi = "http://119.75.6.116/adswebapi/api/posinfo?Asset=" + vehicle + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
 ...
 */
    function playAnimate() {
        ...
        url = "http://119.75.6.116/adswebapi/api/posinfo?Asset=" + vehicle + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
    ...
    * Pausing...
    ...
    function setZones(map, zones, callback) {
        ...
        if (getSessionstorageValueRoleID == 1) {
            ...
            url = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getLocalstorageValueReseller + '&CompanyID=' + getLocalstorageValueCompany;

        } else if (getSessionstorageValueRoleID == 2) {

            url = 'http://119.75.6.116/adswebapi/api/zoneinfo?ResellerID=' + getLocalstorageValueReseller;

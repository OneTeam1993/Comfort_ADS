...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        WebAPI = 'http://119.75.6.116/adswebapi/api/jobinfo?AssetResellerID=' + "1" + '&AssetCompanyID=' + "1" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&JobType=Scheduled' + '&Trip=1' + '&isReturn=1' + '&Flag=1';
    }
    else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'http://119.75.6.116/adswebapi/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + "" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&JobType=Scheduled' + '&Trip=1' + '&isReturn=1' + '&Flag=1';
    }
    else if (getSessionstorageValueRoleID >= 3) {
        WebAPI = 'http://119.75.6.116/adswebapi/api/jobinfo?AssetResellerID=' + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&AssetID=' + getAssets + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&JobType=Scheduled' + '&Trip=1' + '&isReturn=1' + '&Flag=1';
    }
...
function GenerateEN() {
        ...
        var jobApi = 'http://119.75.6.116/adswebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&JobType=Scheduled' + '&Trip=1' + '&isReturn=1' + '&Flag=1';

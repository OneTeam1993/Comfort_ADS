...
//OnLoad User Role
$.getJSON("http://103.237.168.119/adswebapi/api/roleinfo?RoleID=" + getSessionstorageValueRoleID, function (data) {
    $.each(data, function (index, item) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    WebAPIAsset = 'http://103.237.168.119/adswebapi/api/assetinfo?UserID=' + '' + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'http://track.asiacom.co.th/adswebapi/api/userinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&RoleID=' + getSessionstorageValueRoleID;
...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'http://103.237.168.119/adswebapi/api/userinfo?ResellerID=' + '1' + '&CompanyID=' + '1' + '&RoleID=' + getSessionstorageValueRoleID;

    } else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'http://track.asiacom.co.th/adswebapi/api/userinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&RoleID=' + getSessionstorageValueRoleID;
...
//Total Users
var url = 'http://103.237.168.119/adswebapi/api/userinfo';
...
$.getJSON("http://103.237.168.119/adswebapi/api/languageinfo", function (data) {
    $.each(data, function (index, item) {

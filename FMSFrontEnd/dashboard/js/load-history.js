...
//Load Events
$.getJSON("http://103.237.168.119/adswebapi/api/statusinfo", function (data) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("http://103.237.168.119/adswebapi/api/assetinfo", function (data) {
        $.each(data, function (index, item) {
            $('#load-assets2').append(
                 $('<option></option>').val(item.Name).html(item.Name)
             );
    ...
    $.getJSON("http://103.237.168.119/adswebapi/api/assetinfo?UserID=" + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID, function (data) {
        $.each(data, function (index, item) {
            $('#load-assets2').append(
                 $('<option></option>').val(item.Name).html(item.Name)
             );
...
$.getJSON("http://103.237.168.119/adswebapi/api/categoryinfo", function (data) {
    $.each(data, function (index, item) {
    ...
    function Generate() {
        ...
        //if (timestamp < rxtime) {
            ...
            if (validateTimestamp == true && validateRxTime == true) {
                ...
                var WebApiBarlight = "";
                var jobApi = "";
                var WebApiMessages = "http://track.asiacom.co.th/adswebapi/api/messageinfo?Asset=" + getAsset + "&Flag=" + getFlag + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                if (getAsset == "")
                {
                    ...
                    WebApiCVR = "http://103.237.168.119/adswebapi/api/cvrinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Speed=" + convertMilesPerHour;
                    WebApi = "http://103.237.168.119/adswebapi/api/posinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Speed=" + convertMilesPerHour;
                    WebApiBarlight = "http://103.237.168.119/adswebapi/api/posinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Barlight=1";
                    jobApi = 'http://103.237.168.119/adswebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType;
                }
                else
                {
                    if (getReseller == "" || getReseller == "undefined" || getReseller == null)
                    ...
                    WebApiCVR = "http://103.237.168.119/adswebapi/api/cvrinfo?Asset=" + getAsset + "&Speed=" + convertMilesPerHour + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    WebApi = "http://103.237.168.119/adswebapi/api/posinfo?Asset=" + getAsset + "&Speed=" + convertMilesPerHour + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    WebApiBarlight = "http://103.237.168.119/adswebapi/api/posinfo?Asset=" + getAsset + "&Speed=" + convertMilesPerHour + "&Barlight=1" + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    jobApi = 'http://103.237.168.119/adswebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Asset=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType;            
                }
                ...
                if (getLocalstorageValueRetrieveReport == "reports-positions") {
                    ...
                    if (strEvent == 12 | strEvent == 13) {
                        WebApiEvent = "http://track.asiacom.co.th/adswebapi/api/eventinfo/?StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + '&CompanyID=' + getCompany + '&AckRoleID=' + getSessionstorageValueRoleID;
                        ...
                        WebApiEvent = "http://track.asiacom.co.th/adswebapi/api/eventinfo/?Asset=" + getAsset + "&StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
...
$.getJSON("http://103.237.168.119/adswebapi/api/reportinfo", function (data) {
    $.each(data, function (index, item) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    WebAPIAgent = 'http://103.237.168.119/adswebapi/api/userinfo?ResellerID=' + '1' + '&CompanyID=' + '1' + '&RoleID=' + getSessionstorageValueRoleID;

} else if (getSessionstorageValueRoleID == 2) {
    WebAPIAgent = 'http://track.asiacom.co.th/adswebapi/api/userinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&RoleID=' + getSessionstorageValueRoleID;
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("http://103.237.168.119/adswebapi/api/companyinfo", function (data) {
...
if (getSessionstorageValueRoleID == 1) {
    ...
    MobileWebAPIReseller = 'http://103.237.168.119/adswebapi/api/resellerinfo';
    ...
    MobileWebAPIReseller = 'http://103.237.168.119/adswebapi/api/resellerinfo?ResellerID=' + getSessionstorageValueUserResellerID;
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("http://103.237.168.119/adswebapi/api/companyinfo?ResellerID=" + getSessionstorageValueUserResellerID, function (data) {
        $.each(data, function (index, item) {
...
$('#generatemobile').on('click', function () {
    ...
    var webapiMobile = "http://103.237.168.119/adswebapi/api/posinfo?Asset=" + vehicle + "&Speed=" + speed + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var WebApiEvent = "http://track.asiacom.co.th/adswebapi/api/eventinfo/?Asset=" + vehicle + "&StatusID=" + getStatusID + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var WebApiMessages = "http://track.asiacom.co.th/adswebapi/api/messageinfo?Asset=" + vehicle + "&Flag=" + getFlag + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var jobApi = 'http://103.237.168.119/adswebapi/api/jobinfo?AssetResellerID=' + reseller + '&AssetCompanyID=' + company + '&Asset=' + vehicle + '&Timestamp=' + datefrom + '&RxTime=' + dateto + '&Flag=0' + '&Payment=' + getPayment;
        ...
        if (strEvent == 12 | strEvent == 13) {
            ...
            $(document).ready(function () {
                ...
                $('#reports-events').bootstrapTable(
                    {
                        idField: 'EventID',
                        url: 'http://track.asiacom.co.th/adswebapi/api/eventinfo/?StatusID=' + getStatusID + '&Timestamp=' + datefrom + '&RxTime=' + dateto + "&CompanyID=" + company + "&AckRoleID=" + getSessionstorageValueRoleID,
                        columns: [{
                            field: 'Timestamp',
                            title: 'Timestamp',

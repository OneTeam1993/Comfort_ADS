...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'http://track.asiacom.co.th/adswebapi/api/deviceinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
...
$(document).ready(function () {
    ...
    var DeviceAPI = "";
    if (getSessionstorageValueRoleID == 1) {
        DeviceAPI = "http://103.237.168.119/adswebapi/api/deviceinfo?ResellerID=" + "1" + "&CompanyID=" + "1";
    } 
    else if (getSessionstorageValueRoleID == 2){
        DeviceAPI = "http://103.237.168.119/adswebapi/api/deviceinfo?ResellerID=" + getSessionstorageValueUserResellerID + "&CompanyID=" + getSessionstorageValueCompanyID;
    }
...
//Total Users
var url = 'http://103.237.168.119/adswebapi/api/deviceinfo';

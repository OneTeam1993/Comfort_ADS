...
namespace FMSWebApi.Controllers
{
    ...
    public class LogoutAssetController : ApiController
    {
        ...
        {
            //Logger.LogEvent(string.Format("AssetCompanyID: {0} JobDriver: {1} Timestamp: {2} RxTime: {3}", item.AssetCompanyID, item.JobDriver, item.Timestamp, item.RxTime), System.Diagnostics.EventLogEntryType.Warning);

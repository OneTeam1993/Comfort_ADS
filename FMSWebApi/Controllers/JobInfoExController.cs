...
namespace FMSWebApi.Controllers
{
    ...
    public class JobInfoExController : ApiController
    {
        ...
        public IEnumerable<JobInfo> GetByCompanyEx([FromUri]JobInfo param)
        {
            ...
            //if  ((param.Timestamp != DateTime.MinValue) && (param.AssetResellerID > 0 || param.AssetCompanyID > 0 || param.AssetID > 0 || !string.IsNullOrEmpty(param.Asset) || param.Flag > 0 || param.Payment > 0 || !string.IsNullOrEmpty(param.JobStatus) || !string.IsNullOrEmpty(param.Agent) || param.Trip > 0))
            if ((param.Timestamp != DateTime.MinValue) && (param.AssetID > 0 || !string.IsNullOrEmpty(param.Asset)))                                              
            {

...
namespace FMSWebApi.Repository
{
    public class MessageRepository : IMessageRepository
    {
        ...
        //private string mConnStr = "server=localhost;uid=root;pwd=$B$Transit888;database=ads;default command timeout=999999;";
        private string mConnStr = "server=103.237.168.119;uid=root;pwd=@c3c0M;database=ads;default command timeout=999999;";

...
namespace AutoLogoutWinSvc
{
    ...
    internal static class HelperFunctions
    {
        ...
        public static string ToString(this OracleDataReader dbRdr, string strParam)
        {
            // get parameter value
        ...
        /// <param name="dbRdr"></param>
        /// <param name="strParam"></param>
        public static int ToInt32(this OracleDataReader dbRdr, string strParam)
        {
            // get parameter value
        ...
        /// <param name="dbRdr"></param>
        /// <param name="strParam"></param>
        public static long ToInt64(this OracleDataReader dbRdr, string strParam)
        {
            // get parameter value
        ...
        /// <param name="dbRdr"></param>
        /// <param name="strParam"></param>
        public static double ToDouble(this OracleDataReader dbRdr, string strParam)
        {
            // get parameter value
        ...
        /// <param name="dbRdr"></param>
        /// <param name="strParam"></param>
        public static DateTime ToDateTime(this OracleDataReader dbRdr, string strParam)
        {
            // get parameter value
        ...
        /// <param name="dbRdr"></param>
        /// <param name="strParam"></param>
        public static DateTime ToDateTimeMin(this OracleDataReader dbRdr, string strParam)
        {
            // get parameter value

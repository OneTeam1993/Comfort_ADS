    ...
    partial class Service1 : ServiceBase
    {
        ...
        public void RunService()
        {
            ...
            try
            {
                ...
                m_strEmail = "tracksupport@acecom.com.sg";
                ...
                if (Settings.Default.IsSMS) SendSMS("97742532", msg);
        ...
        private void TestEmail()
        {
            try
            {
                ...
                // send email
                SmtpClient smtp = new SmtpClient("mail.acecom.com.sg");
                smtp.DeliveryMethod = SmtpDeliveryMethod.Network;
                smtp.Port = 25;
                smtp.UseDefaultCredentials = false;
                smtp.Credentials = new NetworkCredential(Settings.Default.EmailUser, Settings.Default.EmailPassword);
                smtp.EnableSsl = false;
                smtp.Send(eMail);
                //587
                LogEvent(String.Format("SMTP host {0} port {1}.", smtp.Host, smtp.Port), false);

$(document).ready(function () {
    ...
    //var logoutURL = 'https://track-asia.com/comfort/';
    var logoutURL = '/';
    ...
    function Logout() {
        ...
        var updateUserApi = 'https://track-asia.com/comfortwebapi/api/updateuserinfo?id=' + getSessionstorageValueUserID;
            ...
            success: function (UpdateUser) {
                ...
                $.ajax({
                    ...
                    success: function (getUserLogout) {
                        ...
                        window.location.href = 'https://track-asia.com/comfort/';

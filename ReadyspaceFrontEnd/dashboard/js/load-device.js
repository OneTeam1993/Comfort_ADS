...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'https://track-asia.com/comfortwebapi/api/deviceinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
...
$(document).ready(function () {
    ...
    var DeviceAPI = "";
    if (getSessionstorageValueRoleID == 1) {
        DeviceAPI = "https://track-asia.com/comfortwebapi/api/deviceinfo?ResellerID=" + "1" + "&CompanyID=" + "1";
    } 
    else if (getSessionstorageValueRoleID == 2){
        DeviceAPI = "https://track-asia.com/comfortwebapi/api/deviceinfo?ResellerID=" + getSessionstorageValueUserResellerID + "&CompanyID=" + getSessionstorageValueCompanyID;
    }

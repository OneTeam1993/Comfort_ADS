...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        WebAPIJobDriver = 'https://track-asia.com/comfortwebapi/api/driverinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
    }

    else if (getSessionstorageValueRoleID == 2) {
        WebAPIJobDriver = 'https://track-asia.com/comfortwebapi/api/driverinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        WebAPI = 'https://track-asia.com/comfortwebapi/api/jobinfo?AssetResellerID=' + "1" + '&AssetCompanyID=' + "1" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&JobType=Scheduled' + '&Trip=1' + '&isReturn=1' + '&Flag=1';
    }
    else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'https://track-asia.com/comfortwebapi/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + "" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&JobType=Scheduled' + '&Trip=1' + '&isReturn=1' + '&Flag=1';
    }
    else if (getSessionstorageValueRoleID >= 3) {
        WebAPI = 'https://track-asia.com/comfortwebapi/api/jobinfo?AssetResellerID=' + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&AssetID=' + getAssets + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&JobType=Scheduled' + '&Trip=1' + '&isReturn=1' + '&Flag=1';
    }
...
function GenerateEN() {
        ...
        var jobApi = 'https://track-asia.com/comfortwebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&JobType=Scheduled' + '&Trip=1' + '&isReturn=1' + '&Flag=1';
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueUser == null | getSessionstorageValueUser == undefined | getSessionstorageValueUser == "") {
        ...
        localStorage.clear();
        window.location.href = 'https://track-asia.com/ads/'; //Login URL

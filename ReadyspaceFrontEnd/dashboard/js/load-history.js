    ...
    function Generate() {
        ...
        //if (timestamp < rxtime) {
            ...
            if (validateTimestamp == true && validateRxTime == true) {
                ...
                var jobApi = "";
                var jobApiReport = "";
                var jobApiWardReportOrigin = "";
                var jobApiWardReport = "";
                var WebApiMessages = "http://103.237.168.119/comfortwebapi/api/messageinfo?Asset=" + getAsset + "&Flag=" + getFlag + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                if (getAsset == "")
                {
                    ...
                    WebApiCVR = "https://track-asia.com/comfortwebapi/api/cvrinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Speed=" + convertMilesPerHour;
                    WebApi = "https://track-asia.com/comfortwebapi/api/posinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Speed=" + convertMilesPerHour;
                    WebApiBarlight = "https://track-asia.com/comfortwebapi/api/posinfo?&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + "&Barlight=1";
                    jobApi = 'https://track-asia.com/comfortwebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestampJobs + '&RxTime=' + rxtimeJobs + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType;
                    jobApiReport = 'https://track-asia.com/comfortwebapi/api/jobreport?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestampJobs + '&RxTime=' + rxtimeJobs + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType + '&Origin=' + getOrigin + '&Destination=' + getDestination;
                    jobApiWardReportOrigin = 'https://track-asia.com/comfortwebapi/api/jobwardorigin?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestampJobs + '&RxTime=' + rxtimeJobs + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType + '&Origin=' + getOrigin + '&Destination=' + getDestination;
                    jobApiWardReport = 'https://track-asia.com/comfortwebapi/api/jobward?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestampJobs + '&RxTime=' + rxtimeJobs + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType + '&Origin=' + getOrigin + '&Destination=' + getDestination;
                }
                else
                {
                    if (getReseller == "" || getReseller == "undefined" || getReseller == null)
                    ...
                    WebApiCVR = "https://track-asia.com/comfortwebapi/api/cvrinfo?Asset=" + getAsset + "&Speed=" + convertMilesPerHour + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    WebApi = "https://track-asia.com/comfortwebapi/api/posinfo?Asset=" + getAsset + "&Speed=" + convertMilesPerHour + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    WebApiBarlight = "https://track-asia.com/comfortwebapi/api/posinfo?Asset=" + getAsset + "&Speed=" + convertMilesPerHour + "&Barlight=1" + "&CompanyID=" + getCompany + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                    jobApi = 'https://track-asia.com/comfortwebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Asset=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType;
                    jobApiReport = 'https://track-asia.com/comfortwebapi/api/jobreport?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestampJobs + '&RxTime=' + rxtimeJobs + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType + '&Origin=' + getOrigin + '&Destination=' + getDestination;
                    jobApiWardReportOrigin = 'https://track-asia.com/comfortwebapi/api/jobwardorigin?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestampJobs + '&RxTime=' + rxtimeJobs + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType + '&Origin=' + getOrigin + '&Destination=' + getDestination;
                    jobApiWardReport = 'https://track-asia.com/comfortwebapi/api/jobward?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&Timestamp=' + timestampJobs + '&RxTime=' + rxtimeJobs + '&Flag=0' + '&Payment=' + getPayment + '&JobStatus=' + getJobStatus + '&Agent=' + getAgent + '&Trip=' + getTrip + '&JobDriver=' + getDriver + '&JobType=' + getType + '&Origin=' + getOrigin + '&Destination=' + getDestination;
                }
                ...
                if (getLocalstorageValueRetrieveReport == "reports-positions") {
                    ...
                    if (strEvent == 12 | strEvent == 13) {
                        WebApiEvent = "https://track-asia.com/comfortwebapi/api/eventinfo/?StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime + '&CompanyID=' + getCompany + '&AckRoleID=' + getSessionstorageValueRoleID;
                        ...
                        WebApiEvent = "https://track-asia.com/comfortwebapi/api/eventinfo/?Asset=" + getAsset + "&StatusID=" + getStatusID + "&Timestamp=" + timestamp + "&RxTime=" + rxtime;
                        ...
                        $('#' + getLocalstorageValueRetrieveReport).bootstrapTable(
                            {
                                ...
                                onLoadSuccess: function (data, row) {
                                    ...
                                    else
                                    {
                                        ...
                                        $.ajax({
                                            type: "GET",
                                            url: jobApiWardReportOrigin,
                                            async: false,
                                            dataType: "text",
                                            success: function (data) {

                                                //Set
                                                drawOriginJobWard(data);
...
if (getSessionstorageValueRoleID == 1) {
    ...
    WebAPIAgent = 'https://track-asia.com/comfortwebapi/api/userinfo?ResellerID=' + '1' + '&CompanyID=' + '1' + '&RoleID=' + getSessionstorageValueRoleID;

} else if (getSessionstorageValueRoleID == 2) {
    WebAPIAgent = 'https://track-asia.com/comfortwebapi/api/userinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&RoleID=' + getSessionstorageValueRoleID;
...
if (getSessionstorageValueRoleID == 1) {
    ...
    $.getJSON("https://track-asia.com/comfortwebapi/api/companyinfo", function (data) {
...
$('#generatemobile').on('click', function () {
    ...
    var webapiMobile = "https://track-asia.com/comfortwebapi/api/posinfo?Asset=" + vehicle + "&Speed=" + speed + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var WebApiEvent = "https://track-asia.com/comfortwebapi/api/eventinfo/?Asset=" + vehicle + "&StatusID=" + getStatusID + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var WebApiMessages = "https://track-asia.com/comfortwebapi/api/messageinfo?Asset=" + vehicle + "&Flag=" + getFlag + "&Timestamp=" + datefrom + "&RxTime=" + dateto;
    var jobApi = 'https://track-asia.com/comfortwebapi/api/jobinfo?AssetResellerID=' + reseller + '&AssetCompanyID=' + company + '&Asset=' + vehicle + '&Timestamp=' + datefrom + '&RxTime=' + dateto + '&Flag=0' + '&Payment=' + getPayment;
        ...
        if (strEvent == 12 | strEvent == 13) {
            ...
            $(document).ready(function () {
                ...
                $('#reports-events').bootstrapTable(
                    {
                        idField: 'EventID',
                        url: 'https://track-asia.com/comfortwebapi/api/eventinfo/?StatusID=' + getStatusID + '&Timestamp=' + datefrom + '&RxTime=' + dateto + "&CompanyID=" + company + "&AckRoleID=" + getSessionstorageValueRoleID,
                        columns: [{
                            field: 'Timestamp',
                            title: 'Timestamp',
...
if (getSessionstorageValueRoleID == 1) {
    WebAPIDriver = 'https://track-asia.com/comfortwebapi/api/driverinfoex?ResellerID=' + '1' + '&CompanyID=' + '1';
}

else if (getSessionstorageValueRoleID == 2) {
    WebAPIDriver = 'https://track-asia.com/comfortwebapi/api/driverinfoex?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
...
$(document).ready(function () {
    ...
    $.getJSON("https://track-asia.com/comfortwebapi/api/hospitalinfo", function (data) {
        $.each(data, function (index, item) {
            $('#origin').append($('<option></option>').val(item.Name).html(item.Name));

...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        $.getJSON("https://track-asia.com/comfortwebapi/api/companyinfo?ResellerID=" + getReseller, function (data) {
    ...
    $('.MobileSelectCompanyFilter').on('change', function () {
        ...
        $.getJSON("https://track-asia.com/comfortwebapi/api/companyinfo?ResellerID=" + getMobileReseller, function (data) {
...
$(function () {
    ...
    $('.SelectJobResellerFilter').on('change', function () {
        ...
        $('#jobCompany').empty();
        $('#jobCompany').selectpicker('refresh');
        $.getJSON("https://track-asia.com/comfortwebapi/api/companyinfo?&ResellerID=" + selectedJobReseller, function (data) {
    ...
    $('.SelectJobCompanyFilter').on('change', function () {
        ...
        $.getJSON("https://track-asia.com/comfortwebapi/api/assetinfo?UserID=" + "&ResellerID=" + jobReseller + "&CompanyID=" + selectedJobCompany, function (data) {
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        WebAPI = 'https://track-asia.com/comfortwebapi/api/returninfo?AssetResellerID=' + "1" + '&AssetCompanyID=' + "1" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2' + '&Flag=1';
    }
    else if (getSessionstorageValueRoleID == 2) {
        WebAPI = 'https://track-asia.com/comfortwebapi/api/returninfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + "" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2' + '&Flag=1';
    }
    else if (getSessionstorageValueRoleID >= 3) {
        WebAPI = 'https://track-asia.com/comfortwebapi/api/returninfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&AssetID=' + getAssets + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2' + '&Flag=1';
       // var jobApi = 'https://track-asia.com/comfortwebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2' + '&Flag=1';
    }
...
function GenerateEN() {
        ...
        //var jobApi = 'https://track-asia.com/comfortwebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
        var jobApi = 'https://track-asia.com/comfortwebapi/api/returninfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany + '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&Trip=2' + '&JobType=Scheduled' + '&isReturn=2' + '&Flag=1';
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueUser == null | getSessionstorageValueUser == undefined | getSessionstorageValueUser == "") {
        ...
        localStorage.clear();
        window.location.href = 'https://track-asia.com/royal/'; //Login URL
...
function sendCancelAlert(origin, destination, timestamp) {
    ...
    $.ajax({
        url: "http://103.237.168.119/comfortwebapi/api/messageinfo",
        type: "POST",

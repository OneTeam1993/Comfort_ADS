...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'https://track-asia.com/comfortwebapi/api/resellerinfo';

    } else {

        WebAPI = 'https://track-asia.com/comfortwebapi/api/resellerinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    }

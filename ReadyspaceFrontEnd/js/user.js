...
$(document).ready(function () {
    ...
    $('#submit-user').on('click', function () {
        ...
        var url = 'https://track-asia.com/comfortwebapi/api/login';
        ...
        $.ajax({
            url: "https://track-asia.com/comfortwebapi/api/login",
            type: "POST",
            ...
            success: function (userlogin) {
                ...
                {
                    if (userlogin.LoginRetry == "Active")
                    {
                        //For Comfort Website
                        if (userlogin.CompanyID == 0 || userlogin.CompanyID == 2 || userlogin.CompanyID == 1) {
                            ...
                            var updateUserApi = 'https://track-asia.com/comfortwebapi/api/updateuserinfo?id=' + UpdateUser.UserID;
                            ...
                            $.ajax({
                                ...
                                success: function (UpdateUser) {
                                    ...
                                    $.ajax({
                                        url: "https://track-asia.com/comfortwebapi/api/eventinfo",
                                        type: "POST",

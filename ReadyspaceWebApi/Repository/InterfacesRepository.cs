...
namespace FMSWebApi.Repository
{
    ...
    public interface ISettingsRepository
    {
        ...
        IEnumerable<DistanceMatrixInfo> GetDistanceMatrix(DistanceMatrixInfo param);
    }
    ...
    public interface IJobRepository
    {
        ...
        IEnumerable<JobInfo> GetAllEx();
        IEnumerable<JobReportInfo> GetAllReport();
        IEnumerable<WardInfo> GetAllJobWard();
        IEnumerable<WardPickupInfo> GetAllJobWardOrigin();
        JobInfo Get(int jobID);
        IEnumerable<JobInfo> GetByCompany(JobInfo param);
        IEnumerable<JobInfo> GetByCompanyReturn(JobInfo param);
        IEnumerable<JobReportInfo> GetByCompanyReport(JobReportInfo param);
        IEnumerable<WardInfo> GetByJobWard(JobReportInfo param);
        IEnumerable<WardPickupInfo> GetByJobWardOrigin(JobReportInfo param);
        IEnumerable<JobInfo> GetByScheduleReport(JobInfo param);
        IEnumerable<JobInfo> GetByCompanyEx(JobInfo param);
        IEnumerable<JobInfo> GetByCompanyFilter(JobInfo param);
    ...
    public interface IGenerateJobIDRepository
    {
        IEnumerable<GenerateJobID> GetJobID();
    }
    ...
    public interface IHospitalRepository
    {
        ...
        HospitalInfo Get(int hospitalID);
        HospitalInfo Add(HospitalInfo item);
        bool Remove(int hospitalID);
        bool Update(HospitalInfo item);

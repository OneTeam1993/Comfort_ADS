...
namespace FMSWebApi.Repository
{
    public class UserRepository : IUserRepository
    {
        ...
        private string mConnStr = "server=localhost;uid=root;pwd=@c3c0M;database=comfort;max pool size=500;default command timeout=999999;";
        ...
        public bool UpdateUser(UpdateUserInfo currUser)
        {
            ...
            {
                retVal = false;
                Logger.LogEvent(ex.Message + "-Update(UserLoginRepository)", System.Diagnostics.EventLogEntryType.Error);
            }

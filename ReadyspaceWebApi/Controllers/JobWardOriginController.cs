...
namespace FMSWebApi.Controllers
{
    ...
    public class JobWardOriginController : ApiController
    {
        private static readonly IJobRepository repository = new JobRepository();

        public IEnumerable<WardPickupInfo> GetByJobWard([FromUri]JobReportInfo param)
        {
            ...
            {
                return repository.GetByJobWardOrigin(param);
            }
            else
            {
                return repository.GetAllJobWardOrigin();
            }
        }
